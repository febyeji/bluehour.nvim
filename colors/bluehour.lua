...
vim.g.colors_name = 'bluehour'

local bg = vim.opt.background:get()

-- Only needed for development
local palette = require('bluehour/palettes/' .. bg)
...
if vim.g.bluehour_enable_font_variants == true or vim.g.bluehour_enable_font_variants == nil then
  ...
  undercurl = true
  strikethrough = true
elseif type(vim.g.bluehour_enable_font_variants) == 'table' then
  --- Enable only selected font attributes
  bold = vim.g.bluehour_enable_font_variants.bold
  italic = vim.g.bluehour_enable_font_variants.italic
  underline = vim.g.bluehour_enable_font_variants.underline
  undercurl = vim.g.bluehour_enable_font_variants.undercurl
  strikethrough = vim.g.bluehour_enable_font_variants.strikethrough
end
